        ...
        switch (paramInfo.kind) {
            ...
            case 'pubSub':
                if (paramInfo.triggerKey) {
                    return async (payload) => pubSub.publish(paramInfo.triggerKey, payload);
                }
                return pubSub;
            case 'custom':
...
async function applyMiddlewares(container, resolverData, middlewares, resolverHandlerFunction) {
