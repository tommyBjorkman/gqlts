...
import { ClassType, Complexity, ResolverFilterData, ResolverTopicData, TypeResolver } from '../interfaces';
...
export declare type TypeValueThunk = (type?: any) => TypeValue;
export declare type ClassTypeResolver = (of?: any) => ClassType | Function;
export declare type ReturnTypeFunc = (returns?: any) => ReturnTypeFuncValue;
