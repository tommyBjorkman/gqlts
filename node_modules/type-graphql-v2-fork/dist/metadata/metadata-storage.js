...
class MetadataStorage {
    ...
    buildClassMetadata(definitions, options) {
    ...
    buildResolversMetadata(definitions, options) {
        definitions.forEach(def => {
    ...
    buildFieldResolverMetadata(definitions, options) {
        ...
        definitions.forEach(def => {
            ...
            if (def.kind === 'external') {
                ...
                const typeMetadata = (_a = this.objectTypes.find(objTypeDef => objTypeDef.target === typeClass)) !== null && _a !== void 0 ? _a : this.interfaceTypes.find(interfaceTypeDef => interfaceTypeDef.target === typeClass);
                if (!typeMetadata) {
